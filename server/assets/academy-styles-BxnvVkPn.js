const mathImg = "/mastery/assets/teacher-math-CTSjk9C7.jpg";
const physicsImg = "/mastery/assets/teacher-physics-ExgfF00M.jpg";
const chemistryImg = "/mastery/assets/teacher-chemistry-DhG0G0w9.jpg";
const styles = {
  math: {
