...
const appCss = "/mastery/assets/styles-B4xbKMk3.css";
...
function createSupabaseClient() {
  const SUPABASE_URL = "https://tuymkukcjlkrcarklbdn.supabase.co";
  const SUPABASE_PUBLISHABLE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InR1eW1rdWtjamxrcmNhcmtsYmRuIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzcwMzE0ODgsImV4cCI6MjA5MjYwNzQ4OH0.x8QG32L3clJBN_TH97-OzTvqQ8fIhbnF18DT3Y2H014";
...
const $$splitComponentImporter$A = () => import("./teacher-login-CUurYBRe.js");
const $$splitNotFoundComponentImporter$3 = () => import("./teacher-login-pPq4FNym.js");
const $$splitErrorComponentImporter$3 = () => import("./teacher-login-1ZSoWr-a.js");
const Route$A = createFileRoute("/teacher-login")({
  ...
  loader: async ({
    ...
    if (!deps.academy) return {
      academy: null
    };
    const {
      data,
      error
    } = await supabase.from("academies").select("*").eq("slug", deps.academy).eq("is_published", true).maybeSingle();
    if (error) throw error;
...
const $$splitComponentImporter$z = () => import("./student-login-CahrKASU.js");
const $$splitNotFoundComponentImporter$2 = () => import("./student-login-Ce66E3mQ.js");
const $$splitErrorComponentImporter$2 = () => import("./student-login-CMYikQyJ.js");
const Route$z = createFileRoute("/student-login")({
  validateSearch: (search) => ({
    academy: typeof search.academy === "string" ? search.academy : ""
  }),
  loaderDeps: ({
...
const $$splitComponentImporter$y = () => import("./reset-password-CVMHh5pF.js");
const Route$y = createFileRoute("/reset-password")({
  head: () => ({
    meta: [{
      title: "استرجاع كلمة المرور — EduVerse"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$y, "component")
});
const $$splitComponentImporter$x = () => import("./login-XUeI2-Fk.js");
const Route$x = createFileRoute("/login")({
  head: () => ({
    meta: [{
      title: "دخول الإدارة — EduVerse"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$x, "component")
});
const $$splitComponentImporter$w = () => import("./index-CFabED6f.js");
const $$splitErrorComponentImporter$1 = () => import("./index-r3BvdtuX.js");
const Route$w = createFileRoute("/")({
  loader: async () => {
    const {
      data,
      error
    } = await supabase.from("academies").select("*").eq("is_published", true).order("created_at", {
      ascending: true
    });
    if (error) throw error;
    return {
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "منصة تعليمية احترافية متعددة الأكاديميات تجمع نخبة المعلمين في الرياضيات والفيزياء والكيمياء بتجربة تعلم سينمائية."
    }, {
      property: "og:title",
      content: "EduVerse — منصة الأكاديميات التعليمية"
    }, {
      property: "og:description",
      content: "نخبة المعلمين، اختبارات تفاعلية، تجربة تعلم سينمائية."
    }]
  }),
  errorComponent: lazyRouteComponent($$splitErrorComponentImporter$1, "errorComponent"),
  component: lazyRouteComponent($$splitComponentImporter$w, "component")
});
const $$splitComponentImporter$v = () => import("./dashboard.index-D0dV7unY.js");
const Route$v = createFileRoute("/dashboard/")({
  head: () => ({
    meta: [{
      title: "لوحة التحكم — EduVerse"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$v, "component")
});
const $$splitComponentImporter$u = () => import("./dashboard.teacher-CTH_gJL3.js");
const Route$u = createFileRoute("/dashboard/teacher")({
  head: () => ({
    meta: [{
      title: "لوحة المعلم — EduVerse"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$u, "component")
});
const $$splitComponentImporter$t = () => import("./dashboard.student-ZwsDC97z.js");
const Route$t = createFileRoute("/dashboard/student")({
  head: () => ({
    meta: [{
      title: "لوحة الطالب — EduVerse"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$t, "component")
});
const $$splitComponentImporter$s = () => import("./dashboard.admin-Bt7kBEHR.js");
const Route$s = createFileRoute("/dashboard/admin")({
  head: () => ({
    meta: [{
      title: "لوحة الأدمن العام — EduVerse"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$s, "component")
});
const $$splitComponentImporter$r = () => import("./academy._slug-CV41it99.js");
const $$splitNotFoundComponentImporter$1 = () => import("./academy._slug-Cj5FilME.js");
const Route$r = createFileRoute("/academy/$slug")({
  loader: async ({
    params
  }) => {
    const {
      data,
      error
    } = await supabase.from("academies").select("*").eq("slug", params.slug).eq("is_published", true).maybeSingle();
    if (error) throw error;
    if (!data) throw notFound();
    return {
      academy: data
  ...
  head: ({
    ...
    meta: loaderData ? [{
      ...
      name: "description",
      content: loaderData.academy.description
    }, {
      property: "og:title",
      content: loaderData.academy.name
    }, {
      property: "og:description",
      content: loaderData.academy.description
    }] : []
...
const $$splitComponentImporter$q = () => import("./dashboard.teacher.index-SdAAd0Yc.js");
const Route$q = createFileRoute("/dashboard/teacher/")({
  head: () => ({
    meta: [{
      title: "لوحة المعلم — EduVerse"
    }]
...
const $$splitComponentImporter$p = () => import("./dashboard.student.index-mfcbyOWk.js");
const Route$p = createFileRoute("/dashboard/student/")({
  head: () => ({
    meta: [{
      title: "لوحة الطالب — EduVerse"
    }]
...
const $$splitComponentImporter$o = () => import("./dashboard.teacher.students-BGdlR7MU.js");
const Route$o = createFileRoute("/dashboard/teacher/students")({
  head: () => ({
    meta: [{
      title: "إدارة الطلاب — EduVerse"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$o, "component")
});
const $$splitComponentImporter$n = () => import("./dashboard.teacher.quizzes-CZsdh7AK.js");
const Route$n = createFileRoute("/dashboard/teacher/quizzes")({
  component: lazyRouteComponent($$splitComponentImporter$n, "component")
});
const $$splitComponentImporter$m = () => import("./dashboard.teacher.question-bank-CuIVtNb9.js");
const Route$m = createFileRoute("/dashboard/teacher/question-bank")({
  head: () => ({
    meta: [{
      title: "بنك الأسئلة — EduVerse"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$m, "component")
});
const $$splitComponentImporter$l = () => import("./dashboard.teacher.profile-BfZQa7f4.js");
const Route$l = createFileRoute("/dashboard/teacher/profile")({
  head: () => ({
    meta: [{
      title: "الملف الشخصي — EduVerse"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$l, "component")
});
const $$splitComponentImporter$k = () => import("./dashboard.teacher.messages-QGX_hRv2.js");
const Route$k = createFileRoute("/dashboard/teacher/messages")({
  head: () => ({
    meta: [{
      title: "المراسلة — EduVerse"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$k, "component")
});
const $$splitComponentImporter$j = () => import("./dashboard.teacher.courses-B1azAWBb.js");
const Route$j = createFileRoute("/dashboard/teacher/courses")({
  component: lazyRouteComponent($$splitComponentImporter$j, "component")
});
const $$splitComponentImporter$i = () => import("./dashboard.teacher.articles-qDd0198M.js");
const Route$i = createFileRoute("/dashboard/teacher/articles")({
  head: () => ({
    meta: [{
      title: "المقالات — EduVerse"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$i, "component")
});
const $$splitComponentImporter$h = () => import("./dashboard.teacher.announcements-BIuhHKoD.js");
const Route$h = createFileRoute("/dashboard/teacher/announcements")({
  head: () => ({
    meta: [{
      title: "الإعلانات — EduVerse"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$h, "component")
});
const $$splitComponentImporter$g = () => import("./dashboard.student.quizzes-CJyHXZRL.js");
const Route$g = createFileRoute("/dashboard/student/quizzes")({
  head: () => ({
    meta: [{
      title: "اختباراتي — EduVerse"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$g, "component")
});
const $$splitComponentImporter$f = () => import("./dashboard.student.messages-DGKpfGb1.js");
const Route$f = createFileRoute("/dashboard/student/messages")({
  head: () => ({
    meta: [{
      title: "المراسلة — EduVerse"
    }]
...
const $$splitComponentImporter$e = () => import("./dashboard.student.courses-55ZZlYta.js");
const Route$e = createFileRoute("/dashboard/student/courses")({
  component: lazyRouteComponent($$splitComponentImporter$e, "component")
});
const $$splitComponentImporter$d = () => import("./dashboard.student.articles-DPqGeYAY.js");
const Route$d = createFileRoute("/dashboard/student/articles")({
  head: () => ({
    meta: [{
      title: "المقالات — EduVerse"
    }]
...
const $$splitComponentImporter$c = () => import("./academy._slug.login-BejbLcFE.js");
const $$splitNotFoundComponentImporter = () => import("./academy._slug.login-Irz18l9p.js");
const $$splitErrorComponentImporter = () => import("./academy._slug.login-DjmNCl8Z.js");
const Route$c = createFileRoute("/academy/$slug/login")({
  validateSearch: (search) => ({
...
const $$splitComponentImporter$b = () => import("./dashboard.teacher.quizzes.index-D_2rUatP.js");
const Route$b = createFileRoute("/dashboard/teacher/quizzes/")({
  head: () => ({
    meta: [{
      title: "إدارة الاختبارات — EduVerse"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("./dashboard.teacher.courses.index-BR6Km6nH.js");
const Route$a = createFileRoute("/dashboard/teacher/courses/")({
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("./dashboard.student.courses.index-wpIPt6RE.js");
const Route$9 = createFileRoute("/dashboard/student/courses/")({
  head: () => ({
    meta: [{
      title: "كورساتي — EduVerse"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./dashboard.teacher.quizzes.new-CPwsDv9I.js");
const Route$8 = createFileRoute("/dashboard/teacher/quizzes/new")({
  head: () => ({
    meta: [{
      title: "إنشاء اختبار جديد — EduVerse"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./dashboard.teacher.quizzes._quizId-B8xR0_qE.js");
const Route$7 = createFileRoute("/dashboard/teacher/quizzes/$quizId")({
  head: () => ({
    meta: [{
      title: "أسئلة الاختبار — EduVerse"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./dashboard.teacher.courses._courseId-Ba7fb9hl.js");
const Route$6 = createFileRoute("/dashboard/teacher/courses/$courseId")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./dashboard.student.results._attemptId-DiU5wWsh.js");
const Route$5 = createFileRoute("/dashboard/student/results/$attemptId")({
  head: () => ({
    meta: [{
      title: "نتيجة الاختبار — EduVerse"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./dashboard.student.quiz._quizId-WaYRxvtJ.js");
const Route$4 = createFileRoute("/dashboard/student/quiz/$quizId")({
  head: () => ({
    meta: [{
      title: "اختبار — EduVerse"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./dashboard.student.courses._courseId-NTv7-wLV.js");
const Route$3 = createFileRoute("/dashboard/student/courses/$courseId")({
  head: () => ({
    meta: [{
      title: "محتوى الكورس — EduVerse"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./dashboard.student.academy._academyId-ehFKGVk0.js");
const Route$2 = createFileRoute("/dashboard/student/academy/$academyId")({
  head: () => ({
    meta: [{
      title: "أكاديميتي — EduVerse"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./dashboard.teacher.quizzes._quizId.results-CQUGkJBb.js");
const Route$1 = createFileRoute("/dashboard/teacher/quizzes/$quizId/results")({
  head: () => ({
    meta: [{
      title: "نتائج الاختبار — EduVerse"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./dashboard.student.results._attemptId.review-COpAiwWB.js");
const Route2 = createFileRoute("/dashboard/student/results/$attemptId/review")({
  head: () => ({
    meta: [{
      title: "مراجعة الاختبار — EduVerse"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const TeacherLoginRoute = Route$A.update({
  id: "/teacher-login",
  path: "/teacher-login",
  getParentRoute: () => Route$B
});
const StudentLoginRoute = Route$z.update({
  id: "/student-login",
  path: "/student-login",
  getParentRoute: () => Route$B
});
const ResetPasswordRoute = Route$y.update({
  id: "/reset-password",
  path: "/reset-password",
  getParentRoute: () => Route$B
});
...
const DashboardIndexRoute = Route$v.update({
  id: "/dashboard/",
  path: "/dashboard/",
  getParentRoute: () => Route$B
});
const DashboardTeacherRoute = Route$u.update({
  id: "/dashboard/teacher",
  path: "/dashboard/teacher",
  getParentRoute: () => Route$B
});
const DashboardStudentRoute = Route$t.update({
  id: "/dashboard/student",
  path: "/dashboard/student",
  getParentRoute: () => Route$B
});
const DashboardAdminRoute = Route$s.update({
  id: "/dashboard/admin",
  path: "/dashboard/admin",
  getParentRoute: () => Route$B
});
const AcademySlugRoute = Route$r.update({
  id: "/academy/$slug",
  path: "/academy/$slug",
  getParentRoute: () => Route$B
});
const DashboardTeacherIndexRoute = Route$q.update({
  id: "/",
  path: "/",
  getParentRoute: () => DashboardTeacherRoute
});
const DashboardStudentIndexRoute = Route$p.update({
  id: "/",
  path: "/",
  getParentRoute: () => DashboardStudentRoute
});
const DashboardTeacherStudentsRoute = Route$o.update({
  id: "/students",
  path: "/students",
  getParentRoute: () => DashboardTeacherRoute
});
const DashboardTeacherQuizzesRoute = Route$n.update({
  id: "/quizzes",
  path: "/quizzes",
  getParentRoute: () => DashboardTeacherRoute
});
const DashboardTeacherQuestionBankRoute = Route$m.update({
  id: "/question-bank",
  path: "/question-bank",
  getParentRoute: () => DashboardTeacherRoute
});
const DashboardTeacherProfileRoute = Route$l.update({
  id: "/profile",
  path: "/profile",
  getParentRoute: () => DashboardTeacherRoute
});
const DashboardTeacherMessagesRoute = Route$k.update({
  id: "/messages",
  path: "/messages",
  getParentRoute: () => DashboardTeacherRoute
});
const DashboardTeacherCoursesRoute = Route$j.update({
  id: "/courses",
  path: "/courses",
  getParentRoute: () => DashboardTeacherRoute
});
const DashboardTeacherArticlesRoute = Route$i.update({
  id: "/articles",
  path: "/articles",
  getParentRoute: () => DashboardTeacherRoute
});
const DashboardTeacherAnnouncementsRoute = Route$h.update({
  id: "/announcements",
  path: "/announcements",
  getParentRoute: () => DashboardTeacherRoute
});
const DashboardStudentQuizzesRoute = Route$g.update({
  id: "/quizzes",
  path: "/quizzes",
  getParentRoute: () => DashboardStudentRoute
});
const DashboardStudentMessagesRoute = Route$f.update({
  id: "/messages",
  path: "/messages",
  getParentRoute: () => DashboardStudentRoute
});
const DashboardStudentCoursesRoute = Route$e.update({
  id: "/courses",
  path: "/courses",
  getParentRoute: () => DashboardStudentRoute
});
const DashboardStudentArticlesRoute = Route$d.update({
  id: "/articles",
  path: "/articles",
  getParentRoute: () => DashboardStudentRoute
});
const AcademySlugLoginRoute = Route$c.update({
  id: "/login",
  path: "/login",
  getParentRoute: () => AcademySlugRoute
});
const DashboardTeacherQuizzesIndexRoute = Route$b.update({
  id: "/",
  path: "/",
  getParentRoute: () => DashboardTeacherQuizzesRoute
});
const DashboardTeacherCoursesIndexRoute = Route$a.update({
  id: "/",
  path: "/",
  getParentRoute: () => DashboardTeacherCoursesRoute
});
const DashboardStudentCoursesIndexRoute = Route$9.update({
  id: "/",
  path: "/",
  getParentRoute: () => DashboardStudentCoursesRoute
});
const DashboardTeacherQuizzesNewRoute = Route$8.update({
  id: "/new",
  path: "/new",
  getParentRoute: () => DashboardTeacherQuizzesRoute
});
const DashboardTeacherQuizzesQuizIdRoute = Route$7.update({
  id: "/$quizId",
  path: "/$quizId",
  getParentRoute: () => DashboardTeacherQuizzesRoute
});
const DashboardTeacherCoursesCourseIdRoute = Route$6.update({
  id: "/$courseId",
  path: "/$courseId",
  getParentRoute: () => DashboardTeacherCoursesRoute
});
const DashboardStudentResultsAttemptIdRoute = Route$5.update({
  id: "/results/$attemptId",
  path: "/results/$attemptId",
  getParentRoute: () => DashboardStudentRoute
});
const DashboardStudentQuizQuizIdRoute = Route$4.update({
  id: "/quiz/$quizId",
  path: "/quiz/$quizId",
  getParentRoute: () => DashboardStudentRoute
});
const DashboardStudentCoursesCourseIdRoute = Route$3.update({
  id: "/$courseId",
  path: "/$courseId",
  getParentRoute: () => DashboardStudentCoursesRoute
});
const DashboardStudentAcademyAcademyIdRoute = Route$2.update({
  id: "/academy/$academyId",
  path: "/academy/$academyId",
  getParentRoute: () => DashboardStudentRoute
});
const DashboardTeacherQuizzesQuizIdResultsRoute = Route$1.update({
  id: "/results",
  path: "/results",
  getParentRoute: () => DashboardTeacherQuizzesQuizIdRoute
});
const DashboardStudentResultsAttemptIdReviewRoute = Route2.update({
  id: "/review",
  path: "/review",
  getParentRoute: () => DashboardStudentResultsAttemptIdRoute
});
const AcademySlugRouteChildren = {
  AcademySlugLoginRoute
};
const AcademySlugRouteWithChildren = AcademySlugRoute._addFileChildren(
  AcademySlugRouteChildren
);
const DashboardStudentCoursesRouteChildren = {
  DashboardStudentCoursesCourseIdRoute,
  DashboardStudentCoursesIndexRoute
};
const DashboardStudentCoursesRouteWithChildren = DashboardStudentCoursesRoute._addFileChildren(
  DashboardStudentCoursesRouteChildren
);
const DashboardStudentResultsAttemptIdRouteChildren = {
  DashboardStudentResultsAttemptIdReviewRoute
};
const DashboardStudentResultsAttemptIdRouteWithChildren = DashboardStudentResultsAttemptIdRoute._addFileChildren(
  DashboardStudentResultsAttemptIdRouteChildren
);
const DashboardStudentRouteChildren = {
  DashboardStudentArticlesRoute,
  DashboardStudentCoursesRoute: DashboardStudentCoursesRouteWithChildren,
  DashboardStudentMessagesRoute,
  DashboardStudentQuizzesRoute,
  DashboardStudentIndexRoute,
  DashboardStudentAcademyAcademyIdRoute,
  DashboardStudentQuizQuizIdRoute,
  DashboardStudentResultsAttemptIdRoute: DashboardStudentResultsAttemptIdRouteWithChildren
};
const DashboardStudentRouteWithChildren = DashboardStudentRoute._addFileChildren(DashboardStudentRouteChildren);
const DashboardTeacherCoursesRouteChildren = {
  DashboardTeacherCoursesCourseIdRoute,
  DashboardTeacherCoursesIndexRoute
};
const DashboardTeacherCoursesRouteWithChildren = DashboardTeacherCoursesRoute._addFileChildren(
  DashboardTeacherCoursesRouteChildren
);
const DashboardTeacherQuizzesQuizIdRouteChildren = {
  DashboardTeacherQuizzesQuizIdResultsRoute
};
const DashboardTeacherQuizzesQuizIdRouteWithChildren = DashboardTeacherQuizzesQuizIdRoute._addFileChildren(
  DashboardTeacherQuizzesQuizIdRouteChildren
);
const DashboardTeacherQuizzesRouteChildren = {
  DashboardTeacherQuizzesQuizIdRoute: DashboardTeacherQuizzesQuizIdRouteWithChildren,
  DashboardTeacherQuizzesNewRoute,
  DashboardTeacherQuizzesIndexRoute
};
const DashboardTeacherQuizzesRouteWithChildren = DashboardTeacherQuizzesRoute._addFileChildren(
  DashboardTeacherQuizzesRouteChildren
);
const DashboardTeacherRouteChildren = {
  DashboardTeacherAnnouncementsRoute,
  DashboardTeacherArticlesRoute,
  DashboardTeacherCoursesRoute: DashboardTeacherCoursesRouteWithChildren,
  DashboardTeacherMessagesRoute,
  DashboardTeacherProfileRoute,
  DashboardTeacherQuestionBankRoute,
  DashboardTeacherQuizzesRoute: DashboardTeacherQuizzesRouteWithChildren,
  DashboardTeacherStudentsRoute,
  DashboardTeacherIndexRoute
};
const DashboardTeacherRouteWithChildren = DashboardTeacherRoute._addFileChildren(DashboardTeacherRouteChildren);
