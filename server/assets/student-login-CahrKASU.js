...
import { a as Route, L as Link } from "./router-Ck0CG9hO.js";
import { g as getAcademyStyle } from "./academy-styles-BxnvVkPn.js";
import { S as StudentLoginForm } from "./AcademyLoginForms-ItMg4lvk.js";
import { A as ArrowLeft } from "./arrow-left-BfKhSaUg.js";
...
import "./circle-alert-DTM-TjjN.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen relative overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-md mx-auto px-6 py-16", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `inline-flex size-16 rounded-2xl ${style.bgGradientClass} grid place-items-center mb-4 ${style.glowClass}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(GraduationCap, { className: "size-8 text-primary-foreground" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-bold mb-2", children: "دخول الطالب" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card-premium border border-border/60 rounded-2xl p-6 shadow-elevated", children: academy ? /* @__PURE__ */ jsxRuntimeExports.jsx(StudentLoginForm, { slug: academy.slug }) : /* @__PURE__ */ jsxRuntimeExports.jsx(MissingAcademy, {}) })
    ] })
  ] });
}
function MissingAcademy() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "لا يمكن فتح دخول الطالب بدون تحديد الأكاديمية." }),
